                ...
                <div class="col-12">
                    <div class="flex flex-column xl:flex-row xl:align-items-start p-4 gap-4">
                        <div v-if="show_actions == true"
                            ...
                            <Button
                                v-if="isShowAction('save')"
                                icon="pi pi-save"
                                title="Speichern..."
                                @click.prevent="clickedSave(slotProps.data.id)"/>
...
const emit = defineEmits(['clickedEdit', 'clickedView', 'clickedAdd', 'clickedDelete', 'clickedSave'])
...
const clickedSave = (entryId: string) => {
    console.log("EGclickedSave: " + entryId)
    emit('clickedSave', entryId)
